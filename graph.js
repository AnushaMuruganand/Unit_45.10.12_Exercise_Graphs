...
class Graph {
  ...
  // this function returns an array of Node values using DFS RECURSIVELY
  ...
  // this function returns an array of Node values using DFS ITERATIVELY
  ...
  // this function which accepts a graph, a source vertex and target vertex and returns the shortest path. Can assume our graph is unweighted and undirected.
